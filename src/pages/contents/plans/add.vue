  ...
  <el-main class="content">
    <el-header class="header font-24">
      ...
      <div class="f-r font-16">
        <el-button @click.prevent="submitPlan" type="danger" icon="el-icon-plus">创建任务</el-button>
            ...
            if (this.planDepot!=='') {
              if (this.planCycle!=='') {
                if (this.planFile!=='') {
                  ...
                  form.append('file',this.planFile);
                  ...
                  this.$http.post(this.$store.state.api.plans,form,{
                      headers: {'Content-Type': 'multipart/form-data'}
                    })
                    .then(res => {
                      if(res.status===200 && typeof res.data === 'object') {
                        this.$store.commit("planAdd", res.data);
                        this.$store.commit("linkAdd", {item:res.data,type:'plans'});
                ...
                } else this.$message.error('请上传站点航务文件！');
